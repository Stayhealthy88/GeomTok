...
6. **Nice-to-have:** coordinate-error tail (>2px perceptible rate); StrokeNUWA VQ point on the compression–fidelity scatter; small human forced-choice eval; Figures 1, 3, 4 (Figure 2 done).
